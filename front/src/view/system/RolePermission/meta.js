import {columns, formItems, searchItems} from './settings'
...
export const modalFullscreen = true
...
/* 远程接口地址 */
export const restfulResourcePath = 'sys-role-permissions'
export const name = 'c-sys-role-permissions'
