<template>
  <div>
    ...
    <s-operation-bar v-show="!readonly" id="operationBar" :meta="Object.assign(meta)">

      <Button style="margin-right: 5px;" @click="() => insertRoot()"
              v-permission:create.resource="meta.restfulResourcePath"><i class="el-icon-plus"></i>新增根节点
      </Button>
      ...
      <Col :span="readonly ? 24 : 5">
        <Card :shadow="true" :style="{height: treeHeight, overflowY: 'scroll'}">
          <el-tree ref="tree" :load="loadNode" :lazy="true" :props="meta.props" :show-checkbox="multipleSelect"
                   ...
                   :expand-on-click-node="meta.expandOnClickNode" :default-expand-all="expandAll"
